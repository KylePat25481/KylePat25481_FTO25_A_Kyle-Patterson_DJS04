// Contains the full genreList and a mapping id → title
...
export const genres = Object.fromEntries(genreList.map((g) => [g.id, g.title]));
...
export const genreMap = {
  ...
  3: "Music",
  4: "Business",
  // add all genres provided by the assignment
};
